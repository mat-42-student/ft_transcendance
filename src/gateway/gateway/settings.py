...
# Read bootstrap token from file if path is provided
BOOTSTRAP_TOKEN_PATH = os.environ.get('BOOTSTRAP_TOKEN_PATH')
if BOOTSTRAP_TOKEN_PATH and os.path.exists(BOOTSTRAP_TOKEN_PATH):
    with open(BOOTSTRAP_TOKEN_PATH, 'r') as f:
        VAULT_BOOTSTRAP_TOKEN = f.read().strip()
else:
